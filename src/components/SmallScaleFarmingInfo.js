...
const SmallScaleFarmingInfo = () => {
    ...
    return (
        <div>
            ...
            <Container maxW="800px" mt="50px" p="30px" bg="white" borderWidth="1px" borderRadius="10px" boxShadow="0 5px 15px rgba(0, 0, 0, 0.1)" style={{ margin: '0 auto', marginBottom:'150px', marginTop: '150px', minHeight: "400px", display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                <Heading textAlign="center" fontSize="28px" mb="20px">Small-Scale Farming Information</Heading>
