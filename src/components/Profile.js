                    ...
                    {user ? (
                        <>
                            ...
                            <Box display="flex" justifyContent="center">
                                <Button onClick={handleEditClick} size="md" mr="10px" bg="#007bff" color="#fff" borderRadius="5px" _hover={{ bg: '#0056b3' }} sx={{ width: '100px', height: '40px' }}>Edit</Button>
                                <Button onClick={handleDeleteClick} size="md" colorScheme="red" bg="#007bff" color="#fff" borderRadius="5px" _hover={{ bg: '#0056b3' }} sx={{ width: '100px', height: '40px' }}>Delete</Button>
                            </Box>
                        </>
                    ) : (
